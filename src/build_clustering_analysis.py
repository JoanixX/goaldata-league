"""Clustering experiments for UCL player-season profiles.
...
def build_report(result: ClusteringResult) -> str:
    ...
    return f"""# Clustering and Validation Report

Generated at: `{datetime.now().isoformat(timespec="seconds")}`

## Objective

This report segments the player-season domain and validates whether the
segmentation is meaningful. The experiments use the existing
