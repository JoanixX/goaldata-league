...
\renewcommand{\includegraphics}[2][]{%
    \IfFileExists{\detokenize{#2}}{%
        \Oldincludegraphics[#1]{\detokenize{#2}}%
    }{%
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{pca_player_season_2d.png} % Your player distribution image
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{pca_cumulative_variance.png} % Your variance image
